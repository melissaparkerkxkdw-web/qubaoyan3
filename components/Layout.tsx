        ...
        <div className="max-w-6xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <div className="flex items-center select-none">
             ...
             <div className="flex items-center h-full">
               ...
               {/* 去保研 - Image Logo */}
               {/* Ensure you have a logo_qby.png in your public folder */}
               <div className="ml-2 relative -top-0.5">
                 <img src="/logo_qby.png" alt="去保研" className="h-10 object-contain" onError={(e) => {
                   // Fallback if image is missing, though image is preferred
                   e.currentTarget.style.display = 'none';
                   e.currentTarget.parentElement!.innerHTML = '<span class="text-3xl text-[#059669] font-bold">去保研</span>';
                 }} />
               </div>
